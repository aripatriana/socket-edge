...
public class QueueServiceHandle implements HttpServiceHandler {

    private static final Logger log = LoggerFactory.getLogger(QueueServiceHandle.class);
    private TelemetryRegistry telemetryRegistry;

    public QueueServiceHandle(TelemetryRegistry telemetryRegistry) {
